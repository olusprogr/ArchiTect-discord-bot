...
class Rank(commands.Cog):
    ...
    async def rank(self, ctx, user: Option(discord.Member, "Select a user", default=None)):
        ...
        small_profile_picture = await load_image_async("https://media.discordapp.net/attachments/1133351096371380224/1200840827405094952/Archtietc.webp?ex=65c7a52b&is=65b5302b&hm=ef12f07732a7803c0f5fe3a3570e061289e0204716d8adbdb94f28b606c3677d&=&format=webp")
        small_profile = Editor(small_profile_picture).resize((180, 180)).circle_image()
        background.paste(small_profile, (750, 160))

        level = int(100 / lvl[1] * xp)
