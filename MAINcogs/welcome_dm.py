...
class Commands(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        #embed2.set_thumbnail(url="https://media.discordapp.net/attachments/1133351096371380224/1157333387393110016/Archtietc3.jpg?ex=65183a35&is=6516e8b5&hm=7642cbae776a357d14245853d542167d0f07743e634bd5d7991b014594ec1015&=")

        view = discord.ui.View()
        button = discord.ui.Button(label="Join Discord Server!",
